...
write_rebranding_msg() {
	...
	echo "*** Please modify your processes to download Black Duck Detect from https://detect.blackduck.com/detect9.sh before March 31st, 2025, to prevent script and scan execution failure."
