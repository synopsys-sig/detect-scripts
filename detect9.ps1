...
function Write-RebrandingMsg() {
    ...
    Write-Host "*** Please modify your processes to download Black Duck Detect from https://detect.blackduck.com/detect9.ps1 before September 30th, 2025, to prevent script and scan execution failure."
