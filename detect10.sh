...
write_rebranding_msg() {
	...
	echo "*** Please modify your processes to download Black Duck Detect from https://detect.blackduck.com/detect10.sh before March 31st, 2025, to prevent script and scan execution failure."
	...
	echo "***"
	echo "*** If you are using the Synopsys Detect Azure extension, migrate to the Black Duck Detect Azure extension before March 31st, 2025."
	...
	echo "***"
	echo "*** If you are using Synopsys Detect Jenkins plugin (9.0.0 or prior), migrate to Black Duck Detect Jenkins Plugin 10.0.0 before March 31st, 2025."
